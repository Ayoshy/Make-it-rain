param([string]$OutputDirectory='build/battlestation')
...
cl /nologo /LD /std:c++20 /EHsc /utf-8 /MT "$root\src\Battlestation.Native\Background.cpp" "$root\src\Battlestation.Native\NativeBackground.cpp" User32.lib D2d1.lib Windowscodecs.lib Ole32.lib /link /OUT:"$out\Battlestation.Graphics.dll"
if errorlevel 1 exit /b 1
cl /nologo /LD /std:c++20 /EHsc /utf-8 /MT "$root\src\Battlestation.Native\Desk.cpp" windowsapp.lib Shell32.lib Winhttp.lib User32.lib Gdi32.lib Gdiplus.lib Shlwapi.lib Ole32.lib /link /OUT:"$out\Battlestation.Desk.dll"
...
[IO.File]::WriteAllText((Join-Path $root 'build/current.txt'),$OutputDirectory,[Text.UTF8Encoding]::new($false))
