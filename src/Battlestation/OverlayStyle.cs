...
internal static class OverlayStyle
{
    ...
    {
        window.FontFamily=new FontFamily("Segoe UI Variable Text");window.FontSize=14;window.Foreground=B("#E9E0F2");window.Background=Brushes.Transparent;
        ...
        button.Setters.Add(new Setter(Control.BackgroundProperty,new LinearGradientBrush((Color)ColorConverter.ConvertFromString("#29F1DEFF"),(Color)ColorConverter.ConvertFromString("#10CFB4EE"),90)));
        button.Setters.Add(new Setter(Control.BorderBrushProperty,B("#44D5C5E9")));button.Setters.Add(new Setter(Control.BorderThicknessProperty,new Thickness(1)));
        ...
        var hover=new Trigger{Property=UIElement.IsMouseOverProperty,Value=true};hover.Setters.Add(new Setter(Control.BackgroundProperty,B("#40D4BBEA")));button.Triggers.Add(hover);
        ...
        var check=new Style(typeof(CheckBox));check.Setters.Add(new Setter(Control.ForegroundProperty,B("#E9E0F2")));check.Setters.Add(new Setter(Control.PaddingProperty,new Thickness(7,4,0,4)));check.Setters.Add(new Setter(FrameworkElement.MarginProperty,new Thickness(0,5,0,5)));window.Resources[typeof(CheckBox)]=check;
    }
