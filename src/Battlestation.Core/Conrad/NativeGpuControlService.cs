...
internal sealed class ElevatedGpuControlSession : IDisposable
{
    ...
    private void EnsureConnected()
    {
        ...
        var appHostPath = Path.Combine(Path.GetDirectoryName(typeof(NativeGpuControlService).Assembly.Location)!, "Battlestation.GpuHelper.exe");
        ...
        var pipeName = $"Battlestation.Gpu.{Guid.NewGuid():N}";
