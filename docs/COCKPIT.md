...
couleurs. Les actions du projet sont Explorateur, Codex CLI (ChatGPT), Codex CLI (DS) et
Kilo CLI (DS) ; les variantes (DS) utilisent DeepSeek. Kilo ouvre un nouvel onglet
du terminal dans le projet sélectionné et y démarre `kilo`.
