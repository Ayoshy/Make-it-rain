# Guide de Battlestation

[← Page d'accueil](../README.md)

[Disposition](#applications-et-disposition) · [Scènes](#scènes-et-apparence) · [Docks](#docks-et-périphériques) · [Terminal et projets](#terminal-projets-et-palette) · [Compiler](#compiler-et-lancer)
...
DualSense, Réseau, Achats, LoL, Bloc-notes et Atelier. Le compteur Vice City peut être retiré sans
toucher au reste.
...
- **Réglages → Apparence** : transparence du verre, animation du fond et réactivité
  ...
  Voir [les scènes et ambiances](THEMES_SCENES.md).
- Les titres de dock partagent la police Art déco d'Atelier. Au survol, un liseré
  ...
  minuteur d'animation supplémentaire. Voir [le style commun](LIQUID_GLASS.md).
## Docks et périphériques
...
- **Vidéo** : choisir YouTube, Twitch ou Stremio, puis cliquer **Activer le miroir**.
  ...
  revient au lecteur. Voir [l'intégration Brave et Stremio](VIDEO.md).
- **Bluetooth** : quatre dessins nacrés sur le même fond liquid glass que les
  ...
  Voir [le fonctionnement et les preuves Bluetooth](BLUETOOTH.md).
...
- **DualSense** : ajout depuis Réorganiser → Ajouter, ou depuis la scène Jeu. Boutons,
  ...
  **Traînée tactile** suit deux doigts ; ce mode Bluetooth amélioré demande un
  ...
  Voir [les détails et vérifications](DUALSENSE.md).
- **Réseau** : débits, courbes sur 60 secondes et latence vers une cible configurable.
  **Détail par application** demande une autorisation Windows et affiche les cinq
  exécutables les plus actifs. Voir [le fonctionnement du réseau](NETWORK.md).
- **Achats** : décrire une demande et un budget (« frigo max 800 €, no frost,
  ...
  ouvre l'annonce. Voir [le radar d'achat](SHOPPING.md).
...
## Terminal, projets et palette

- Clic droit sur un onglet terminal : couleur, nom et titre automatique. Les états
  Codex ont un indicateur animé ; voir [les onglets](TERMINAL_TABS.md).
...
La tâche Windows `Battlestation` lance le build courant
...
Voir [l'architecture](ARCHITECTURE.md), [l'intégration vidéo](VIDEO.md)
et [les crédits](PROVENANCE.md).

Le build courant réunit aussi le [cockpit audio, fond musical, dispositions,
états projets et réserve de liens](COCKPIT.md). La compilation ne modifie jamais
